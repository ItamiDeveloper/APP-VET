-- =======================================================
-- SCRIPT COMPLETO: ELIMINAR, CREAR E INSERTAR DATOS
-- VETERINARIA_SAAS (MySQL)
-- =======================================================
-- EJECUTA TODO ESTE SCRIPT EN MYSQL WORKBENCH
-- =======================================================
...
-- Agregar FK a USUARIO en la tabla DOCTOR
ALTER TABLE DOCTOR
...
-- Insertar usuarios con password BCrypt correcto
...
SELECT COUNT(*) AS TotalTablas FROM information_schema.tables WHERE table_schema = 'VETERINARIA_SAAS';
