package com.vet.spring.app.service.planService.planImpl;
...
import com.vet.spring.app.mapper.planMapper.PlanMapper;
...
public class PlanServiceImpl implements PlanService {
    ...
    public PlanDTO update(Integer id, PlanDTO dto) {
        ...
        return planRepository.findById(id).map(existing -> {
            ...
            if (dto.getEstado() != null) existing.setEstado(Enum.valueOf(com.vet.spring.app.entity.veterinaria.Estado.class, dto.getEstado()));
